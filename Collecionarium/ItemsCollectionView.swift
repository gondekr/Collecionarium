...
class ItemsCollectionView: UICollectionViewController, UIGestureRecognizerDelegate, UICollectionViewDelegateFlowLayout, IParseDelegate {
...
//    }
    ...
    override func viewDidLoad() {
        ...
        tutoView = Tutorial(frame: CGRectMake(0, 0, (collectionView?.frame.width)!, (collectionView?.frame.height)!-64), type: .Item)
    ...
    func collectionView(collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAtIndexPath indexPath: NSIndexPath) -> CGSize {
        let x = (self.collectionView?.frame.width)!/CGFloat(itemsRow) - 20
        if (cloudColl != nil ? (cloudColl["titleIndex"] as! Int) == -1 : localColl.titleIndex == -1) {
    ...
    override func numberOfSectionsInCollectionView(tableView: UICollectionView) -> Int {
        return 1
    }
